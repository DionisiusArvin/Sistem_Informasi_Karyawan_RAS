            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm border border-transparent dark:border-gray-700">
                ...
                <form method="POST" action="{{ route('projects.store') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="kode_proyek" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-500 focus:ring-blue-500"
                            type="text" name="kode_proyek" :value="old('kode_proyek')" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="client_name" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-500 focus:ring-blue-500"
                            type="text" name="client_name" :value="old('client_name')" required />
                    ...
                    <div class="mt-4">
                        ...
                        <select id="category" name="category"
                            class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="contract_value"
                            ...
                            type="number" min="0" name="contract_value"
                            :value="old('contract_value')" placeholder="Contoh: 50000000" />
