            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <form action="{{ route('ad-hoc-tasks.update', $task->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" class="w-full border rounded-lg px-3 py-2 dark:bg-gray-900 text-gray-800 dark:text-gray-200">{{ old('descrition', $task->description) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="assigned_to_id" class="w-full border rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" class="w-full border rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
